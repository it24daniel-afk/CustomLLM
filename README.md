...
- **Architecture:** The adventure of constructing the transformer model block by block.
- **Training Odyssey:** The intensive process of pre-training on unlabeled data and the focused journey of fine-tuning for specific tasks.
- **Optimization Expedition:** Navigating the challenges of running and training sophisticated models on accessible hardware, including my own setup:
...
16. OS Automation Linux/Windows (terminal,cmd,powershell, other tools e.g., nmap, sqlmap, metasploit, etc.)
17. Biometics (Face Recognition, Voice Recognition)
